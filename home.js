...
deliveryAreaZipCodes = [85205, 85204, 85203, 85213, 85206]

// const canWeDeliver = zipCode => {
//     for(let x = 0; x < deliveryAreaZipCodes.length; i++){
//         if ( zideCode == deliveryAreaZipCodes){
//         console.log("elgible for deliever")
//         }   else
//         console.log('Sorry, we can't deliever to that address')
//     }
// }
...
//     for(let x = 0; x < deliveryAreaZipCodes.length; i++){
//         if ( zipeCode = includes.deliveryAreaZipCodes){
//         console.log("elgible for deliever")
//         }   else
//         console.log('Sorry, we can't deliever to that address')
//     }
